...
def print_menu(exits):
    ...
    for i in exits:
        ...
        if i == "east":
            b = exit_leads_to(exits, "east")
            print_menu_line("east", b)
        elif i == "west":
            b = exit_leads_to(exits, "west")
            print_menu_line("west", b)
        elif i == "north":
            b = exit_leads_to(exits, "north")
            print_menu_line("north", b)
        elif i == "south":
            b = exit_leads_to(exits, "south")
            print_menu_line("south", b)
...
def menu(exits):
    ...
    while True:
        print_menu(exits)
        where = input(": ")
        norm = normalise_input(where)
        if is_valid_exit(exits, norm):
            return norm
